  ...
  def test_un_libro_con_una_artista_de_argentina_tiene_nacionalidad_argentina(self):
    un_libro_corto = Libro("Socorro", 299, "Terror", {"nombre": "Elsa", "apellido": "Bornemann", "nacionalidad": "Argentina" })
  ...
  def test_un_libro_con_una_artista_de_mexico_tiene_nacionalidad_mexico(self):
    un_libro_corto = Libro("Como agua para chocolate", 216, "Realismo mágico", {"nombre": "Laura", "apellido": "Esquivel", "nacionalidad": "México" })

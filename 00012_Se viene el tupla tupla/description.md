El uso más común de las tuplas es cuando queremos retornar más de una cosa y sabemos exactamente cuántas. Recordemos que las funciones solo retornan un valor pero si ese valor es una tupla… :wink:
